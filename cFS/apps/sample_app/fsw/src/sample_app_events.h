...
#define SAMPLE_APP_FULL_PROGRAM_INF_EID          8
#define SAMPLE_APP_PARTIAL_PROGRAM_INF_EID          9
#define SAMPLE_APP_RESET_INF_EID          10
#define SAMPLE_APP_INPUT_INF_EID          11
#define SAMPLE_APP_OUTPUT_INF_EID          12
