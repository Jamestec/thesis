...
int32 FIR_APP_Input (FIR_APP_Input_t *Msg)
{
	...
	//CFE_EVS_SendEvent(FIR_APP_INPUT_INF_EID, CFE_EVS_EventType_INFORMATION,
	//	"FIR: Input = %d", Payload->number);
	//CFE_ES_WriteToSysLog("FIR App WriteToSysLog: Input: %d", Payload->number);
...
int32 FIR_APP_Output (FIR_APP_Output_t *Msg)
{
	...
	//CFE_EVS_SendEvent(FIR_APP_INPUT_INF_EID, CFE_EVS_EventType_INFORMATION,
	//	"FIR: Output = %d, Done = %d", Payload->Output, Payload->Done);
	//CFE_ES_WriteToSysLog("FIR App WriteToSysLog: Done: %d, Output: %d", Payload->Done, Payload->Output);
    return CFE_SUCCESS;
...
int32 FIR_APP_Delay (FIR_APP_NoopCmd_t *Msg)
{
	...
	//CFE_ES_WriteToSysLog("FIR App: sizeof(cpuaddr) = %ld", sizeof(cpuaddr));
	OS_TaskDelay(5000);
	CFE_EVS_SendEvent(FIR_APP_OUTPUT_INF_EID, CFE_EVS_EventType_INFORMATION,
		"FIR App: Finish OS_TaskDelay for 5 seconds.");
	//CFE_ES_WriteToSysLog("FIR App: Finish OS_TaskDelay for 5 seconds.");
    return CFE_SUCCESS;
