...
// This is the C library version of fpgam.
// The prototype before being imported to cFS as a cFS library.
// Based off of Xilinx's fpgautil.c, which is also included in this repo.
